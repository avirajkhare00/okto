...
const abi_js_1 = require("../helper/abi.js");
const constants_js_1 = require("../helper/constants.js");
const generatePaymasterData_js_1 = require("../utils/generatePaymasterData.js");
const nonceToBigInt_js_1 = require("../helper/nonceToBigInt.js");
const invokeExecuteUserOp_js_1 = require("../utils/invokeExecuteUserOp.js");
const getChains_js_1 = require("../explorer/getChains.js");
const dotenv_1 = __importDefault(require("dotenv"));
const getOrderHistory_js_1 = require("../utils/getOrderHistory.js");
 ...
 */
function transferToken(data, sessionConfig, OktoAuthToken, feePayerAddress) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const chains = yield (0, getChains_js_1.getChains)(OktoAuthToken);
        ...
        //   }
        // ]
        const currentChain = chains.find((chain) => chain.caip_id.toLowerCase() === data.caip2Id.toLowerCase());
        if (!currentChain) {
            throw new Error(`Chain Not Supported`);
        }
        // if feePayerAddress is not provided, it will be set to the default value '0x0000000000000000000000000000000000000000
        if (!feePayerAddress) {
            feePayerAddress = constants_js_1.Constants.FEE_PAYER_ADDRESS;
        }
        console.log("feePayerAddress:", feePayerAddress);
        console.log("current chain:", currentChain);
        // create the UserOp Call data for token transfer intent
        const calldata = (0, viem_1.encodeAbiParameters)((0, viem_1.parseAbiParameters)("bytes4, address,uint256, bytes"), [
            constants_js_1.Constants.EXECUTE_USEROP_FUNCTION_SELECTOR,
            constants_js_1.Constants.ENV_CONFIG.SANDBOX.JOB_MANAGER_ADDRESS,
            constants_js_1.Constants.USEROP_VALUE,
            (0, viem_1.encodeFunctionData)({
                abi: abi_js_1.INTENT_ABI,
                functionName: constants_js_1.Constants.FUNCTION_NAME,
                args: [
                    (0, viem_1.toHex)((0, nonceToBigInt_js_1.nonceToBigInt)(nonce), { size: 32 }),
                    clientSWA,
                    sessionConfig.userSWA,
                    feePayerAddress,
                    (0, viem_1.encodeAbiParameters)((0, viem_1.parseAbiParameters)("(bool gsnEnabled, bool sponsorshipEnabled)"), [
                        {
                            gsnEnabled: (_a = currentChain.gsn_enabled) !== null && _a !== void 0 ? _a : false,
                            sponsorshipEnabled: (_b = currentChain.sponsorship_enabled) !== null && _b !== void 0 ? _b : false,
                        },
                    ]),
                    (0, viem_1.encodeAbiParameters)((0, viem_1.parseAbiParameters)(gsnDataAbiType), [
                        {
                            isRequired: false,
                            requiredNetworks: [],
                            tokens: [],
                    ...
                    (0, viem_1.encodeAbiParameters)((0, viem_1.parseAbiParameters)(jobParametersAbiType), [
                        {
                    ...
                    constants_js_1.Constants.INTENT_TYPE.TOKEN_TRANSFER,
                ],
            }),
        ]);
        ...
        const gasPrice = yield (0, invokeExecuteUserOp_js_1.getUserOperationGasPrice)(OktoAuthToken);
        ...
        const userOp = {
            ...
            nonce: (0, viem_1.toHex)((0, nonceToBigInt_js_1.nonceToBigInt)(nonce), { size: 32 }),
            paymaster: constants_js_1.Constants.ENV_CONFIG.SANDBOX.PAYMASTER_ADDRESS, //paymaster address
            callGasLimit: (0, viem_1.toHex)(constants_js_1.Constants.GAS_LIMITS.CALL_GAS_LIMIT),
            verificationGasLimit: (0, viem_1.toHex)(constants_js_1.Constants.GAS_LIMITS.VERIFICATION_GAS_LIMIT),
            preVerificationGas: (0, viem_1.toHex)(constants_js_1.Constants.GAS_LIMITS.PRE_VERIFICATION_GAS),
            maxFeePerGas: gasPrice.maxFeePerGas,
            maxPriorityFeePerGas: gasPrice.maxPriorityFeePerGas,
            paymasterPostOpGasLimit: (0, viem_1.toHex)(constants_js_1.Constants.GAS_LIMITS.PAYMASTER_POST_OP_GAS_LIMIT),
            paymasterVerificationGasLimit: (0, viem_1.toHex)(constants_js_1.Constants.GAS_LIMITS.PAYMASTER_VERIFICATION_GAS_LIMIT),
            callData: calldata,
            paymasterData: yield (0, generatePaymasterData_js_1.paymasterData)({
                nonce,
                validUntil: new Date(Date.now() + 6 * constants_js_1.Constants.HOURS_IN_MS),
            }),
        };
        console.log("Unsigned UserOp: ", userOp);
        // Sign the userOp
        const signedUserOp = yield (0, invokeExecuteUserOp_js_1.signUserOp)(userOp, sessionConfig);
        ...
        // }
        // Execute the userOp
        const jobId = yield (0, invokeExecuteUserOp_js_1.executeUserOp)(signedUserOp, OktoAuthToken);
        console.log("Job ID:", jobId);
        // Sample Response:
        // jobId: a0a54427-11c8-4140-bfcc-e96af15ce9cf
        // Check the status of the jobId and get the transaction details
        const txn_details = yield (0, getOrderHistory_js_1.getOrderHistory)(OktoAuthToken, jobId, "TOKEN_TRANSFER");
