...
exports.loginUsingOAuth = void 0;
const uuid_1 = require("uuid");
const viem_1 = require("viem");
const sessionKey_1 = require("./sessionKey");
const generatePaymasterData_1 = require("./generatePaymasterData");
const invokeAuthenticate_1 = require("./invokeAuthenticate");
...
function generateAuthPayload(authData, sessionKey, clientSWA, clientPriv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        payload.sessionData.paymaster =
            constants_1.Constants.ENV_CONFIG.SANDBOX.PAYMASTER_ADDRESS; // okto testnet paymaster address
        payload.sessionData.paymasterData = yield (0, generatePaymasterData_1.generatePaymasterData)(clientSWA, clientPriv, nonce, new Date(Date.now() + 6 * constants_1.Constants.HOURS_IN_MS), // hours in milliseconds
        0);
        ...
        const message = {
            raw: (0, viem_1.toBytes)((0, viem_1.keccak256)((0, viem_1.encodeAbiParameters)((0, viem_1.parseAbiParameters)("address"), [
                sessionKey.ethereumAddress,
            ]))),
        };
        payload.sessionPkClientSignature = yield (0, accounts_1.signMessage)({
            message,
            privateKey: clientPriv,
        });
        payload.sessionDataUserSignature = yield (0, accounts_1.signMessage)({
            message,
...
const loginUsingOAuth = (idToken, provider) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const session = sessionKey_1.SessionKey.create();
    ...
    const authPayload = yield generateAuthPayload(data, session, clientSWA, clientPrivateKey);
    ...
    try {
        ...
        const response = yield (0, invokeAuthenticate_1.invokeAuthenticate)(authPayload);
...
exports.loginUsingOAuth = loginUsingOAuth;
